...
datasetDir <- "/Shared/tientong_scratch/abcd/derivatives/freesurfer/" # Change Directory to your data
setwd(datasetDir) 
dataset_name <- "abcd" # Provide name of your study and/or dataset
