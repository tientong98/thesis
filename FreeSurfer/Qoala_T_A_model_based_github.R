...
inputFolder <- "/Shared/tientong_scratch/abcd/derivatives/freesurfer/"
# Create output directory if it doesnt exist  
outputFolder <- "/Shared/tientong_scratch/abcd/derivatives/freesurfer/" 
...
setwd(inputFolder)
dataset_name <- "abcd" # Provide name of your study and/or dataset (same as dataset name in Stats2Table script)
