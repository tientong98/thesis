...
python /Shared/tientong_scratch/test500/abcd2bids_convert/abcd2bids_github/abcd2bids.py /Shared/pinc/sharedopt/apps/fsl/Linux/x86_64/5.0.8 /Shared/tientong_scratch/test500/abcd2bids_convert/R2016b/v91 --username tientong 2>&1 | tee ${log}
